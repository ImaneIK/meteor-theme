<template>
  <div class="pt-24 ">
    ...
    <div v-if="!loading" class="flex justify-between mx-12  divide-x">
      ...
      <div class="w-1/3 divide-y px-4">

        <!-- About Page Block -->
        <div class="m-8 bg-neutral-100 p-8 text-center ">
          <h2 class="text-xl font-semibold mb-2">About Us</h2>
          <img :src="$settings.header.logo.src" />
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          <nuxt-link to="/about" class="block m-4 bg-black text-white text-xs p-2 rounded-md mt-2">
            Show more
          </nuxt-link>
        </div>
        ...
        <div class="p-8 text-center items-center">
