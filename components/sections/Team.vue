          ...
          <div class="w-full space-y-12 lg:w-1/2">
            <div>
              <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl">
                {{$settings.sections.team.heading}}
              </h1>

              <div class="mt-2">
                <span :style="`background: ${$settings.theme.colors.accent};`" class="inline-block w-40 h-1 rounded-full"></span>
                <span :style="`background: ${$settings.theme.colors.accent};`" class="inline-block w-3 h-1 ml-1 rounded-full"></span>
                <span :style="`background: ${$settings.theme.colors.accent};`" class="inline-block w-1 h-1 ml-1 rounded-full"></span>
              </div>
            </div>
            ...
            <div class="md:flex md:items-start md:-mx-4">
              <span
                ...
                class="inline-block p-2 rounded-xl md:mx-4"
                v-html= $settings.sections.team.mission.icon
              >
              </span>

              <div class="mt-4 md:mx-4 md:mt-0">
                <h1 class="text-xl font-semibold text-gray-700 capitalize">
                  {{ $settings.sections.team.mission.title }}
                </h1>

                <p class="mt-3 text-gray-500">
                  {{ $settings.sections.team.mission.description }}
                </p>
              </div>
            </div>
            ...
            <div class="md:flex md:items-start md:-mx-4">
              <span
                :style="`background: ${$settings.theme.colors.accent}; color: ${$settings.theme.colors.primary};`"
                class="inline-block p-2 rounded-xl md:mx-4"
                v-html = $settings.sections.team.amenities.icon
              >
              </span>
              ...
              <div class="mt-4 md:mx-4 md:mt-0">
                <h1 class="text-xl font-semibold text-gray-700 capitalize">
                  {{$settings.sections.team.amenities.title}}
                </h1>

                <p class="mt-3 text-gray-500">
                  {{$settings.sections.team.amenities.description}}
                </p>
              </div>
            </div>
            ...
            <div class="md:flex md:items-start md:-mx-4">
              <span
                :style="`background: ${$settings.theme.colors.accent}; color: ${$settings.theme.colors.primary};`"
                class="inline-block p-2 rounded-xl md:mx-4"
                v-html= $settings.sections.team.community.icon
              >
              ...
              <div class="mt-4 md:mx-4 md:mt-0">
                <h1 class="text-xl font-semibold text-gray-700 capitalize">
                  {{$settings.sections.team.community.title}}
                </h1>

                <p class="mt-3 text-gray-500">
                  {{$settings.sections.team.community.description}}
                </p>
              </div>
            </div>
          </div>
