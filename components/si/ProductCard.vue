<template>
    <div class="inline-block flex flex-col sm:flex-row max-w-2xl mx-auto my-4 w-full bg-white rounded-sm shadow-md">
      <!-- space image -->
      <div class="relative" style="flex: 0 0 40%">
              <img
                ...
                :alt="title"
              />
              <p class="absolute top-0 left-0 m-2 flex items-center gap-1 bg-black text-yellow-400 text-xs p-2 rounded-lg">
                <svg stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="fill-yellow-400 w-4 h-4" viewBox="0 0 24 24"> <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path></svg>
                {{ rating }}  </p>
            </div>
